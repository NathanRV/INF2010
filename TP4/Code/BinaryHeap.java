...
public class BinaryHeap<AnyType extends Comparable<? super AnyType>> extends AbstractQueue<AnyType>
{
    ...
    public String nonRecursivePrintFancyTree()
    {
        ...
        ArrayDeque<Integer> tabIndex = new ArrayDeque<Integer>();// index
        ArrayDeque<AnyType> tabVal = new ArrayDeque<AnyType>(); // valeurs
        ArrayDeque<String> tabPrefix = new ArrayDeque<String>(); //string prefix a ajouter

        //Premier ajout pour le root
        tabVal.add(array[1]);
        tabIndex.add(1);
        tabPrefix.add("");
